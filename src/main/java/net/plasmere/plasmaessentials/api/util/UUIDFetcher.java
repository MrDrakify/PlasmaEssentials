...
public class UUIDFetcher {
    ...
    public static ServerPlayerEntity getSPlayer(UUID uuid){
        try {
            return PlasmaEssentials.getInstance().getServer().getPlayerManager().getPlayer(uuid);
        } catch (Exception e){
            e.printStackTrace();
            return null;
        }
    ...
    public static Player getPlayer(ServerPlayerEntity player) {
        try {
            String name = getCachedName(player.getUuid());
